...
void adm2bssn_pt1(CCTK_ARGUMENTS) {
    ...
    grid.loop_int_device<VVV_centered[0], VVV_centered[1], VVV_centered[2], vsize>(grid.nghostzones, [=] CCTK_DEVICE(const PointDesc& p) CCTK_ATTRIBUTE_ALWAYS_INLINE {    
        ...
        x27 = pow2(access(gxz, stencil_idx_0_0_0_VVV));
        x28 = pow2(access(gxy, stencil_idx_0_0_0_VVV));
        x29 = pow2(access(gyz, stencil_idx_0_0_0_VVV));
        x30 = ((access(gxx, stencil_idx_0_0_0_VVV) * x29) + (access(gyy, stencil_idx_0_0_0_VVV) * x27) + (access(gzz, stencil_idx_0_0_0_VVV) * x28) + (-1 * access(gxx, stencil_idx_0_0_0_VVV) * access(gyy, stencil_idx_0_0_0_VVV) * access(gzz, stencil_idx_0_0_0_VVV)) + (-2 * access(gxy, stencil_idx_0_0_0_VVV) * access(gxz, stencil_idx_0_0_0_VVV) * access(gyz, stencil_idx_0_0_0_VVV)));
        ...
        vreal x7 = (access(kxx, stencil_idx_0_0_0_VVV) * x6 * (x29 + (-1 * access(gyy, stencil_idx_0_0_0_VVV) * access(gzz, stencil_idx_0_0_0_VVV))));
        vreal x13 = (access(kyy, stencil_idx_0_0_0_VVV) * x6 * (x27 + (-1 * access(gxx, stencil_idx_0_0_0_VVV) * access(gzz, stencil_idx_0_0_0_VVV))));
        ...
        vreal x19 = (access(gyy, stencil_idx_0_0_0_VVV) * x10);
        vreal x18 = ((1.0 / 3.0) * access(gyy, stencil_idx_0_0_0_VVV));
        ...
        x18 = ((1.0 / 3.0) * access(gxz, stencil_idx_0_0_0_VVV));
        x19 = (access(gxz, stencil_idx_0_0_0_VVV) * x10);
        ...
        store(AtDD22, stencil_idx_0_0_0_VVV, (x5 * (access(kzz, stencil_idx_0_0_0_VVV) + (-1 * x10 * x13) + (-1 * x10 * x15) + (-1 * x10 * x7) + (-1 * x12 * x22) + (-1 * x14 * x22) + (-1 * x22 * x9))));
        ...
        x5 = (2 * x6);
        store(trK, stencil_idx_0_0_0_VVV, (x13 + x15 + x7 + (x12 * x5) + (x14 * x5) + (x5 * x9)));    
    });
    #ifdef __CUDACC__
    nvtxRangeEnd(range);
    #endif
