...
void apply_dissipation(CCTK_ARGUMENTS) {
    ...
    grid.loop_int_device<VVV_centered[0], VVV_centered[1], VVV_centered[2], vsize>(grid.nghostzones, [=] CCTK_DEVICE(const PointDesc& p) CCTK_ATTRIBUTE_ALWAYS_INLINE {    
        ...
        x284 = stencil(gtDD00, stencil_idx_m2_0_0_VVV);
        x285 = stencil(gtDD00, stencil_idx_2_0_0_VVV);
        x286 = ((x284 + x285));
        x287 = stencil(gtDD00, stencil_idx_m1_0_0_VVV);
        x288 = stencil(gtDD00, stencil_idx_1_0_0_VVV);
        x289 = ((x287 + x288));
        x290 = stencil(gtDD00, stencil_idx_0_m2_0_VVV);
        x291 = stencil(gtDD00, stencil_idx_0_2_0_VVV);
        x292 = ((x290 + x291));
        x293 = stencil(gtDD00, stencil_idx_0_m1_0_VVV);
        x294 = stencil(gtDD00, stencil_idx_0_1_0_VVV);
        x295 = ((x293 + x294));
        x296 = stencil(gtDD00, stencil_idx_0_0_m2_VVV);
        vreal x83 = stencil(gtDD00, stencil_idx_0_0_2_VVV);
        vreal x247 = ((x296 + x83));
        x83 = stencil(gtDD00, stencil_idx_0_0_m1_VVV);
        vreal x85 = stencil(gtDD00, stencil_idx_0_0_1_VVV);
        vreal x248 = ((x83 + x85));
        x85 = (-0.312500000000000 * stencil(gtDD00, stencil_idx_0_0_0_VVV));
        store(gt_rhsDD00, stencil_idx_0_0_0_VVV, (access(gt_rhsDD00, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x85 + ((1.0 / 64.0) * ((stencil(gtDD00, stencil_idx_m3_0_0_VVV) + stencil(gtDD00, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x289) + (-0.0937500000000000 * x286))) + (DYI * (x85 + ((1.0 / 64.0) * ((stencil(gtDD00, stencil_idx_0_m3_0_VVV) + stencil(gtDD00, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x295) + (-0.0937500000000000 * x292))) + (DZI * (x85 + ((1.0 / 64.0) * ((stencil(gtDD00, stencil_idx_0_0_m3_VVV) + stencil(gtDD00, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x248) + (-0.0937500000000000 * x247)))))));
        x247 = stencil(gtDD01, stencil_idx_m2_0_0_VVV);
        x248 = stencil(gtDD01, stencil_idx_2_0_0_VVV);
        vreal x250 = ((x247 + x248));
        vreal x156 = stencil(gtDD01, stencil_idx_m1_0_0_VVV);
        vreal x157 = stencil(gtDD01, stencil_idx_1_0_0_VVV);
        vreal x251 = ((x156 + x157));
        x156 = stencil(gtDD01, stencil_idx_0_m2_0_VVV);
        x157 = stencil(gtDD01, stencil_idx_0_2_0_VVV);
        vreal x252 = ((x156 + x157));
        vreal x120 = stencil(gtDD01, stencil_idx_0_m1_0_VVV);
        vreal x121 = stencil(gtDD01, stencil_idx_0_1_0_VVV);
        vreal x253 = ((x120 + x121));
        x120 = stencil(gtDD01, stencil_idx_0_0_m2_VVV);
        x121 = stencil(gtDD01, stencil_idx_0_0_2_VVV);
        vreal x254 = ((x120 + x121));
        vreal x62 = stencil(gtDD01, stencil_idx_0_0_m1_VVV);
        vreal x63 = stencil(gtDD01, stencil_idx_0_0_1_VVV);
        vreal x255 = ((x62 + x63));
        x62 = (-0.312500000000000 * stencil(gtDD01, stencil_idx_0_0_0_VVV));
        store(gt_rhsDD01, stencil_idx_0_0_0_VVV, (access(gt_rhsDD01, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x62 + ((1.0 / 64.0) * ((stencil(gtDD01, stencil_idx_m3_0_0_VVV) + stencil(gtDD01, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x251) + (-0.0937500000000000 * x250))) + (DYI * (x62 + ((1.0 / 64.0) * ((stencil(gtDD01, stencil_idx_0_m3_0_VVV) + stencil(gtDD01, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x253) + (-0.0937500000000000 * x252))) + (DZI * (x62 + ((1.0 / 64.0) * ((stencil(gtDD01, stencil_idx_0_0_m3_VVV) + stencil(gtDD01, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x255) + (-0.0937500000000000 * x254)))))));
        x250 = stencil(gtDD02, stencil_idx_m2_0_0_VVV);
        x251 = stencil(gtDD02, stencil_idx_2_0_0_VVV);
        x252 = ((x250 + x251));
        x253 = stencil(gtDD02, stencil_idx_m1_0_0_VVV);
        x254 = stencil(gtDD02, stencil_idx_1_0_0_VVV);
        x255 = ((x253 + x254));
        x63 = stencil(gtDD02, stencil_idx_0_m2_0_VVV);
        vreal x56 = stencil(gtDD02, stencil_idx_0_2_0_VVV);
        vreal x259 = ((x56 + x63));
        x56 = stencil(gtDD02, stencil_idx_0_m1_0_VVV);
        vreal x58 = stencil(gtDD02, stencil_idx_0_1_0_VVV);
        vreal x260 = ((x56 + x58));
        x58 = stencil(gtDD02, stencil_idx_0_0_m2_VVV);
        vreal x172 = stencil(gtDD02, stencil_idx_0_0_2_VVV);
        vreal x261 = ((x172 + x58));
        x172 = stencil(gtDD02, stencil_idx_0_0_m1_VVV);
        vreal x174 = stencil(gtDD02, stencil_idx_0_0_1_VVV);
        vreal x262 = ((x172 + x174));
        x174 = (-0.312500000000000 * stencil(gtDD02, stencil_idx_0_0_0_VVV));
        store(gt_rhsDD02, stencil_idx_0_0_0_VVV, (access(gt_rhsDD02, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x174 + ((1.0 / 64.0) * ((stencil(gtDD02, stencil_idx_m3_0_0_VVV) + stencil(gtDD02, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x255) + (-0.0937500000000000 * x252))) + (DYI * (x174 + ((1.0 / 64.0) * ((stencil(gtDD02, stencil_idx_0_m3_0_VVV) + stencil(gtDD02, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x260) + (-0.0937500000000000 * x259))) + (DZI * (x174 + ((1.0 / 64.0) * ((stencil(gtDD02, stencil_idx_0_0_m3_VVV) + stencil(gtDD02, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x262) + (-0.0937500000000000 * x261)))))));
        x259 = stencil(gtDD11, stencil_idx_m2_0_0_VVV);
        x260 = stencil(gtDD11, stencil_idx_2_0_0_VVV);
        x261 = ((x259 + x260));
        x262 = stencil(gtDD11, stencil_idx_m1_0_0_VVV);
        vreal x103 = stencil(gtDD11, stencil_idx_1_0_0_VVV);
        vreal x265 = ((x103 + x262));
        x103 = stencil(gtDD11, stencil_idx_0_m2_0_VVV);
        vreal x111 = stencil(gtDD11, stencil_idx_0_2_0_VVV);
        vreal x266 = ((x103 + x111));
        x111 = stencil(gtDD11, stencil_idx_0_m1_0_VVV);
        vreal x113 = stencil(gtDD11, stencil_idx_0_1_0_VVV);
        vreal x267 = ((x111 + x113));
        x113 = stencil(gtDD11, stencil_idx_0_0_m2_VVV);
        vreal x46 = stencil(gtDD11, stencil_idx_0_0_2_VVV);
        vreal x268 = ((x113 + x46));
        x46 = stencil(gtDD11, stencil_idx_0_0_m1_VVV);
        vreal x48 = stencil(gtDD11, stencil_idx_0_0_1_VVV);
        vreal x269 = ((x46 + x48));
        x48 = (-0.312500000000000 * stencil(gtDD11, stencil_idx_0_0_0_VVV));
        store(gt_rhsDD11, stencil_idx_0_0_0_VVV, (access(gt_rhsDD11, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x48 + ((1.0 / 64.0) * ((stencil(gtDD11, stencil_idx_m3_0_0_VVV) + stencil(gtDD11, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x265) + (-0.0937500000000000 * x261))) + (DYI * (x48 + ((1.0 / 64.0) * ((stencil(gtDD11, stencil_idx_0_m3_0_VVV) + stencil(gtDD11, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x267) + (-0.0937500000000000 * x266))) + (DZI * (x48 + ((1.0 / 64.0) * ((stencil(gtDD11, stencil_idx_0_0_m3_VVV) + stencil(gtDD11, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x269) + (-0.0937500000000000 * x268)))))));
        x265 = stencil(gtDD12, stencil_idx_m2_0_0_VVV);
        x266 = stencil(gtDD12, stencil_idx_2_0_0_VVV);
        x267 = ((x265 + x266));
        x268 = stencil(gtDD12, stencil_idx_m1_0_0_VVV);
        x269 = stencil(gtDD12, stencil_idx_1_0_0_VVV);
        vreal x272 = ((x268 + x269));
        ...
        store(gt_rhsDD12, stencil_idx_0_0_0_VVV, (access(gt_rhsDD12, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x270 + ((1.0 / 64.0) * ((stencil(gtDD12, stencil_idx_m3_0_0_VVV) + stencil(gtDD12, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x272) + (-0.0937500000000000 * x267))) + (DYI * (x270 + ((1.0 / 64.0) * ((stencil(gtDD12, stencil_idx_0_m3_0_VVV) + stencil(gtDD12, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x274) + (-0.0937500000000000 * x273))) + (DZI * (x270 + ((1.0 / 64.0) * ((stencil(gtDD12, stencil_idx_0_0_m3_VVV) + stencil(gtDD12, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x276) + (-0.0937500000000000 * x275)))))));
        x270 = stencil(gtDD22, stencil_idx_m2_0_0_VVV);
        x272 = stencil(gtDD22, stencil_idx_2_0_0_VVV);
        x273 = ((x270 + x272));
        x274 = stencil(gtDD22, stencil_idx_m1_0_0_VVV);
        x275 = stencil(gtDD22, stencil_idx_1_0_0_VVV);
        x276 = ((x274 + x275));
        vreal x36 = stencil(gtDD22, stencil_idx_0_m2_0_VVV);
        vreal x37 = stencil(gtDD22, stencil_idx_0_2_0_VVV);
        vreal x280 = ((x36 + x37));
        x36 = stencil(gtDD22, stencil_idx_0_m1_0_VVV);
        x37 = stencil(gtDD22, stencil_idx_0_1_0_VVV);
        vreal x281 = ((x36 + x37));
        vreal x165 = stencil(gtDD22, stencil_idx_0_0_m2_VVV);
        vreal x166 = stencil(gtDD22, stencil_idx_0_0_2_VVV);
        vreal x282 = ((x165 + x166));
        x165 = stencil(gtDD22, stencil_idx_0_0_m1_VVV);
        x166 = stencil(gtDD22, stencil_idx_0_0_1_VVV);
        vreal x283 = ((x165 + x166));
        vreal x277 = (-0.312500000000000 * stencil(gtDD22, stencil_idx_0_0_0_VVV));
        store(gt_rhsDD22, stencil_idx_0_0_0_VVV, (access(gt_rhsDD22, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x277 + ((1.0 / 64.0) * ((stencil(gtDD22, stencil_idx_m3_0_0_VVV) + stencil(gtDD22, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x276) + (-0.0937500000000000 * x273))) + (DYI * (x277 + ((1.0 / 64.0) * ((stencil(gtDD22, stencil_idx_0_m3_0_VVV) + stencil(gtDD22, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x281) + (-0.0937500000000000 * x280))) + (DZI * (x277 + ((1.0 / 64.0) * ((stencil(gtDD22, stencil_idx_0_0_m3_VVV) + stencil(gtDD22, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x283) + (-0.0937500000000000 * x282)))))));
        x277 = stencil(w, stencil_idx_m2_0_0_VVV);
        x280 = stencil(w, stencil_idx_2_0_0_VVV);
        x281 = ((x277 + x280));
        x282 = stencil(w, stencil_idx_m1_0_0_VVV);
        x283 = stencil(w, stencil_idx_1_0_0_VVV);
        vreal x303 = ((x282 + x283));
        ...
        vreal x297 = (-0.312500000000000 * stencil(w, stencil_idx_0_0_0_VVV));
        store(w_rhs, stencil_idx_0_0_0_VVV, (access(w_rhs, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x297 + ((1.0 / 64.0) * ((stencil(w, stencil_idx_m3_0_0_VVV) + stencil(w, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x303) + (-0.0937500000000000 * x281))) + (DYI * (x297 + ((1.0 / 64.0) * ((stencil(w, stencil_idx_0_m3_0_VVV) + stencil(w, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x309) + (-0.0937500000000000 * x306))) + (DZI * (x297 + ((1.0 / 64.0) * ((stencil(w, stencil_idx_0_0_m3_VVV) + stencil(w, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x315) + (-0.0937500000000000 * x312)))))));    
    });
    grid.loop_int_device<VVV_centered[0], VVV_centered[1], VVV_centered[2], vsize>(grid.nghostzones, [=] CCTK_DEVICE(const PointDesc& p) CCTK_ATTRIBUTE_ALWAYS_INLINE {    
        const GF3D5index stencil_idx_m1_0_0_VVV(VVV_layout, p.I - p.DI[0]);
        const GF3D5index stencil_idx_m2_0_0_VVV(VVV_layout, p.I - 2*p.DI[0]);
    ...
    grid.loop_int_device<VVV_centered[0], VVV_centered[1], VVV_centered[2], vsize>(grid.nghostzones, [=] CCTK_DEVICE(const PointDesc& p) CCTK_ATTRIBUTE_ALWAYS_INLINE {    
        ...
        x535 = stencil(evo_lapse, stencil_idx_m2_0_0_VVV);
        x536 = stencil(evo_lapse, stencil_idx_2_0_0_VVV);
        x537 = ((x535 + x536));
        x538 = stencil(evo_lapse, stencil_idx_m1_0_0_VVV);
        x539 = stencil(evo_lapse, stencil_idx_1_0_0_VVV);
        x540 = ((x538 + x539));
        x541 = stencil(evo_lapse, stencil_idx_0_m2_0_VVV);
        x542 = stencil(evo_lapse, stencil_idx_0_2_0_VVV);
        x543 = ((x541 + x542));
        x544 = stencil(evo_lapse, stencil_idx_0_m1_0_VVV);
        x545 = stencil(evo_lapse, stencil_idx_0_1_0_VVV);
        x546 = ((x544 + x545));
        x547 = stencil(evo_lapse, stencil_idx_0_0_m2_VVV);
        vreal x447 = stencil(evo_lapse, stencil_idx_0_0_2_VVV);
        vreal x448 = ((x447 + x547));
        x447 = stencil(evo_lapse, stencil_idx_0_0_m1_VVV);
        vreal x450 = stencil(evo_lapse, stencil_idx_0_0_1_VVV);
        vreal x451 = ((x447 + x450));
        x450 = (-0.312500000000000 * stencil(evo_lapse, stencil_idx_0_0_0_VVV));
        store(evo_lapse_rhs, stencil_idx_0_0_0_VVV, (access(evo_lapse_rhs, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x450 + ((1.0 / 64.0) * ((stencil(evo_lapse, stencil_idx_m3_0_0_VVV) + stencil(evo_lapse, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x540) + (-0.0937500000000000 * x537))) + (DYI * (x450 + ((1.0 / 64.0) * ((stencil(evo_lapse, stencil_idx_0_m3_0_VVV) + stencil(evo_lapse, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x546) + (-0.0937500000000000 * x543))) + (DZI * (x450 + ((1.0 / 64.0) * ((stencil(evo_lapse, stencil_idx_0_0_m3_VVV) + stencil(evo_lapse, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x451) + (-0.0937500000000000 * x448)))))));
        x448 = stencil(evo_shiftU0, stencil_idx_m2_0_0_VVV);
        x451 = stencil(evo_shiftU0, stencil_idx_2_0_0_VVV);
        vreal x455 = ((x448 + x451));
        ...
        x462 = stencil(evo_shiftU0, stencil_idx_0_0_m2_VVV);
        x463 = stencil(evo_shiftU0, stencil_idx_0_0_2_VVV);
        vreal x467 = ((x462 + x463));
        ...
        x468 = (-0.312500000000000 * stencil(evo_shiftU0, stencil_idx_0_0_0_VVV));
        store(evo_shift_rhsU0, stencil_idx_0_0_0_VVV, (access(evo_shift_rhsU0, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x468 + ((1.0 / 64.0) * ((stencil(evo_shiftU0, stencil_idx_m3_0_0_VVV) + stencil(evo_shiftU0, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x458) + (-0.0937500000000000 * x455))) + (DYI * (x468 + ((1.0 / 64.0) * ((stencil(evo_shiftU0, stencil_idx_0_m3_0_VVV) + stencil(evo_shiftU0, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x464) + (-0.0937500000000000 * x461))) + (DZI * (x468 + ((1.0 / 64.0) * ((stencil(evo_shiftU0, stencil_idx_0_0_m3_VVV) + stencil(evo_shiftU0, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x470) + (-0.0937500000000000 * x467)))))));
        x455 = stencil(evo_shiftU1, stencil_idx_m2_0_0_VVV);
        x458 = stencil(evo_shiftU1, stencil_idx_2_0_0_VVV);
        x461 = ((x455 + x458));
        x464 = stencil(evo_shiftU1, stencil_idx_m1_0_0_VVV);
        x467 = stencil(evo_shiftU1, stencil_idx_1_0_0_VVV);
        x470 = ((x464 + x467));
        x469 = stencil(evo_shiftU1, stencil_idx_0_m2_0_VVV);
        vreal x479 = stencil(evo_shiftU1, stencil_idx_0_2_0_VVV);
        vreal x480 = ((x469 + x479));
        x479 = stencil(evo_shiftU1, stencil_idx_0_m1_0_VVV);
        vreal x482 = stencil(evo_shiftU1, stencil_idx_0_1_0_VVV);
        vreal x483 = ((x479 + x482));
        x482 = stencil(evo_shiftU1, stencil_idx_0_0_m2_VVV);
        vreal x485 = stencil(evo_shiftU1, stencil_idx_0_0_2_VVV);
        vreal x486 = ((x482 + x485));
        x485 = stencil(evo_shiftU1, stencil_idx_0_0_m1_VVV);
        vreal x488 = stencil(evo_shiftU1, stencil_idx_0_0_1_VVV);
        vreal x489 = ((x485 + x488));
        x488 = (-0.312500000000000 * stencil(evo_shiftU1, stencil_idx_0_0_0_VVV));
        store(evo_shift_rhsU1, stencil_idx_0_0_0_VVV, (access(evo_shift_rhsU1, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x488 + ((1.0 / 64.0) * ((stencil(evo_shiftU1, stencil_idx_m3_0_0_VVV) + stencil(evo_shiftU1, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x470) + (-0.0937500000000000 * x461))) + (DYI * (x488 + ((1.0 / 64.0) * ((stencil(evo_shiftU1, stencil_idx_0_m3_0_VVV) + stencil(evo_shiftU1, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x483) + (-0.0937500000000000 * x480))) + (DZI * (x488 + ((1.0 / 64.0) * ((stencil(evo_shiftU1, stencil_idx_0_0_m3_VVV) + stencil(evo_shiftU1, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x489) + (-0.0937500000000000 * x486)))))));
        x480 = stencil(evo_shiftU2, stencil_idx_m2_0_0_VVV);
        x483 = stencil(evo_shiftU2, stencil_idx_2_0_0_VVV);
        x486 = ((x480 + x483));
        x489 = stencil(evo_shiftU2, stencil_idx_m1_0_0_VVV);
        vreal x495 = stencil(evo_shiftU2, stencil_idx_1_0_0_VVV);
        vreal x496 = ((x489 + x495));
        x495 = stencil(evo_shiftU2, stencil_idx_0_m2_0_VVV);
        vreal x498 = stencil(evo_shiftU2, stencil_idx_0_2_0_VVV);
        vreal x499 = ((x495 + x498));
        x498 = stencil(evo_shiftU2, stencil_idx_0_m1_0_VVV);
        vreal x501 = stencil(evo_shiftU2, stencil_idx_0_1_0_VVV);
        vreal x502 = ((x498 + x501));
        x501 = stencil(evo_shiftU2, stencil_idx_0_0_m2_VVV);
        vreal x504 = stencil(evo_shiftU2, stencil_idx_0_0_2_VVV);
        vreal x505 = ((x501 + x504));
        x504 = stencil(evo_shiftU2, stencil_idx_0_0_m1_VVV);
        vreal x507 = stencil(evo_shiftU2, stencil_idx_0_0_1_VVV);
        vreal x508 = ((x504 + x507));
        x507 = (-0.312500000000000 * stencil(evo_shiftU2, stencil_idx_0_0_0_VVV));
        store(evo_shift_rhsU2, stencil_idx_0_0_0_VVV, (access(evo_shift_rhsU2, stencil_idx_0_0_0_VVV) + (dissipation_epsilon * ((DXI * (x507 + ((1.0 / 64.0) * ((stencil(evo_shiftU2, stencil_idx_m3_0_0_VVV) + stencil(evo_shiftU2, stencil_idx_3_0_0_VVV)))) + (0.234375000000000 * x496) + (-0.0937500000000000 * x486))) + (DYI * (x507 + ((1.0 / 64.0) * ((stencil(evo_shiftU2, stencil_idx_0_m3_0_VVV) + stencil(evo_shiftU2, stencil_idx_0_3_0_VVV)))) + (0.234375000000000 * x502) + (-0.0937500000000000 * x499))) + (DZI * (x507 + ((1.0 / 64.0) * ((stencil(evo_shiftU2, stencil_idx_0_0_m3_VVV) + stencil(evo_shiftU2, stencil_idx_0_0_3_VVV)))) + (0.234375000000000 * x508) + (-0.0937500000000000 * x505)))))));    
    });
    #ifdef __CUDACC__
    nvtxRangeEnd(range);
    #endif
