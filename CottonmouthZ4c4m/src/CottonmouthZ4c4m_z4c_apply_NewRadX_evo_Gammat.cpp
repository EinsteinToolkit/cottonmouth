...
void z4c_apply_NewRadX_evo_Gammat(CCTK_ARGUMENTS) {
    DECLARE_CCTK_ARGUMENTSX_z4c_apply_NewRadX_evo_Gammat;
    DECLARE_CCTK_PARAMETERS;
    using vreal = CCTK_REAL;
    constexpr std::size_t vsize = 0;
    #ifdef __CUDACC__
    const nvtxRangeId_t range = nvtxRangeStartA("z4c_apply_NewRadX_evo_Gammat");
    #endif
    NewRadX_Apply(cctkGH, evo_GammatU0, evo_Gammat_rhsU0, 0, 1, radpower_evo_Gammat);
    NewRadX_Apply(cctkGH, evo_GammatU1, evo_Gammat_rhsU1, 0, 1, radpower_evo_Gammat);
    NewRadX_Apply(cctkGH, evo_GammatU2, evo_Gammat_rhsU2, 0, 1, radpower_evo_Gammat);
    #ifdef __CUDACC__
    nvtxRangeEnd(range);
    #endif
}